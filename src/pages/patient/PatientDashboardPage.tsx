    ...
    try {
      ...
      if (baseResponse.code === 'XS0001') {
        ...
        setProfile({
          ...
          email: user.email,
          phone: user.phone,
          dateOfBirth: '', // if you want to add from backend later
          gender: user.gender || '',
  ...
  const handleProfileUpdate = async (e: React.FormEvent) => {
    ...
    try {
      await api.put('/api/v1/user/user-profile-update', {
        ...
        upazilaId: 5, // 🛑 here you can set dynamically later
        gender: editProfile.gender,
        area: editProfile.area
      });
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-6xl mx-auto">
        ...
        {/* You already have this working, keeping same */}
      ...
      {showConfirmModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg p-6 max-w-sm w-full">
            ...
            <p className="text-gray-600 mb-6">Are you sure you want to mark yourself as unavailable for blood donation?</p>
